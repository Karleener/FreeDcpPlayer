...
// RunMyDcpPlayer.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CRunMyDcpPlayerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CRunMyDcpPlayerApp

CRunMyDcpPlayerApp::CRunMyDcpPlayerApp()
{
...
// Le seul et unique objet CRunMyDcpPlayerApp

CRunMyDcpPlayerApp theApp;


// Initialisation de CRunMyDcpPlayerApp

BOOL CRunMyDcpPlayerApp::InitInstance()
{
